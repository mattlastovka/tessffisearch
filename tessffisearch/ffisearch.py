...
def search_for_transit(time, flux, mass, radius, num_threads):
    ...
    results = model.power(use_threads=num_threads, M_star=mass, M_star_min=0.8*mass[0], 
                            M_star_max=1.2*mass[0], R_star=radius, R_star_min=0.8*radius[0], R_star_max=1.2*radius,
